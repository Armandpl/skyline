...
# calibrated on 3264x2464 images using the real camera
K = np.array(
    [
        [8.07001664e02, 0.00000000e00, 1.76957654e03],
        [0.00000000e00, 8.06263613e02, 1.24194797e03],
        [0.00000000e00, 0.00000000e00, 1.00000000e00],
    ]
)

# original image size with which we calibrated
IM_W = 3264
IM_H = 2464

# size of the image we render w/ Blender
SIM_W = 816
SIM_H = 616

# crop center x, center y, w, h in the rendered image
CROP_X, CROP_Y, CROP_W, CROP_H = 437, 293, 375, 250
CROP_LEFT = CROP_X - CROP_W / 2
CROP_TOP = CROP_Y - CROP_H / 2

# compute center relative to image size
CENTER_X = K[0, 2] / IM_W
CENTER_Y = K[1, 2] / IM_H

# found using cv2.fisheye
D = np.array([-0.01037957, -0.00319831, 0.00031144, -0.00028906])
